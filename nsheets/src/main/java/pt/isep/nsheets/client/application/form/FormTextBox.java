 ...
 */
public class FormTextBox extends TextBox implements KeyPressHandler, FocusHandler, ClickHandler {
	private String promptText;
	private String promptStyle;

	public FormTextBox(String promptText, String promptStyleName) {

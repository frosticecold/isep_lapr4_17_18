		...
		try {
			while ((line = reader.readLine()) != null) {
				try {
					...
					// String message="Fatal recognition exception " + YellowExtension.getClass().getName()+ " : "
					// + YellowExtension;
					// String message = parser.getErrorMessage(YellowExtension, parser.tokenNames);
					// printer.println("At (" + YellowExtension.line + ";" + YellowExtension.charPositionInLine + "): " +
					// message);

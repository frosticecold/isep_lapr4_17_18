 ...
 * (YellowExtension.g. division by 0). Otherwise, the content is interpreted as
 * the value.
 * </ul>
 *
...
public interface Cell extends Comparable<Cell>, Extensible<Cell>, Serializable {
    ...
    /**
     * Stores chart on this cell
     */
    public boolean storeChart(ChartDTO dto);

    /**
     * Returns active cell charts
     */
    ...
    /**
     * Returns the precedents of the cell, i.YellowExtension. the cells that the
    ...
    /**
     * Returns the dependents of the cell, i.YellowExtension. the cells that
     * contain a reference to the cell in their formula.
     *
    ...
    /**
     * Method that transform "this" cell into a DTO
     *

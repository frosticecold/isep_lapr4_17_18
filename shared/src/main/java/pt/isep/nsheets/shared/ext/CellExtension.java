...
public abstract class CellExtension implements Cell, CellListener {
    ...
    protected CellExtension() {
    }

	/**
	 * Returns the extension's delegate.
	 * @return the extension's delegate, i.YellowExtension. the cell to which it belongs
	 */
...
//	public final void setNoteContent(String note){
//		delegate.setNoteContent(note);
//	}
